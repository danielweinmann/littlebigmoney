class Channel < ActiveRecord::Base
  ...
  attr_accessible :description, :name, :permalink, :email, :twitter, :facebook, :website, :image, :video_url, :how_it_works, :banner_url, :matchfunding_factor, :matchfunding_percentage, :matchfunding_user, :matchfunding_user_id, :matchfunding_maximum, :matchfunding_maximum_per_project, :show_drafts, :legend, :receive_projects
  schema_associations

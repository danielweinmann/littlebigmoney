...
response = HTTParty.post "http://localhost:3000/es/projects/8/backers", body: URI::encode("backer[value]=25000&backer[reward_id]=4&backer[anonymous]=1"), headers: { "Authorization" => "Token token=\"#{access_token}\"" }
